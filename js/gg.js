...
var sjjson={
    's2009':{"swbmsr":"250688480284.44","sssr":"159678240000","fssr":"90861650000","sbjjsr":"72647710000",
      ...
      "fcs":"6862890000","ccs":"1111130000","yys1":"9080000","gdzys":"0","gdzctjs":"20104","qt":"0","bsj":""},
    's2010':{"swbmsr":"333287360889.54","sssr":"223826436070.4","fssr":"109460924819.14","sbjjsr":"86464895561.6",
      ...
      "fcs":"7196532677.52","ccs":"1619785828.54","yys1":"6679523.92","gdzys":"4406040426.19","gdzctjs":"34733.84","qt":"0","bsj":""},
    's2011':{"swbmsr":"412236089338.63","sssr":"268879726397.75","fssr":"143356362940.88","sbjjsr":"114437870675.5",
      ...
      "fcs":"9919444764.38","ccs":"1913374872.43","yys1":"6565347.68","gdzys":"5137517940.88","gdzctjs":"263117.89","qt":"263117.89","bsj":""},
    's2012':{"swbmsr":"464395987675.28","sssr":"292377839960.03","fssr":"172018147715.25","sbjjsr":"141244175955.41",
      ...
      "fcs":"12693544403.69","ccs":"2848763273.45","yys1":"9045868.07","gdzys":"6472536204.55","gdzctjs":"0","qt":"0","bsj":""},
    's2013':{"swbmsr":"501989643322.49","sssr":"306701742424.95","fssr":"195737930897.54","sbjjsr":"163593975289.27",
      ...
      "fcs":"13410835453.52","ccs":"3385725310.58","yys1":"9465623.84","gdzys":"5870060530.32","gdzctjs":"24331.6","qt":"0","bsj":""},
    's2014':{"swbmsr":"565040758264.88","sssr":"332951406699.56","fssr":"232089351565.32","sbjjsr":"197640855710.24",
      ...
      "fcs":"15842920830.92", "ccs":"3845796841.95","yys1":"2293620.56","gdzys":"6324030081.1","gdzctjs":"0","qt":"0","bsj":""},
    's2015':{"swbmsr":"617189729892.61","sssr":"354558024653.14","fssr":"262631705239.47","sbjjsr":"225575319808.64",
      ...
      "fcs":"17665093251.9","ccs":"4202603376.93","yys1":"1310898.07","gdzys":"6165967106.58","gdzctjs":"0","qt":"0","bsj":""},
  }//公共历史数据
var s2009=[];
var s2010=[];
var s2011=[];
...
sjjson.s2009.bsj=parseFloat(sjjson.s2009.zys)+parseFloat(sjjson.s2009.tdsys)+parseFloat(sjjson.s2009.cjs)+
  ...
  parseFloat(sjjson.s2009.gdzctjs)+parseFloat(sjjson.s2009.qt)+parseFloat(sjjson.s2009.gdzys);
sjjson.s2010.bsj=parseFloat(sjjson.s2010.zys)+parseFloat(sjjson.s2010.tdsys)+parseFloat(sjjson.s2010.cjs)+
  ...
  parseFloat(sjjson.s2010.gdzctjs)+parseFloat(sjjson.s2010.qt)+parseFloat(sjjson.s2010.gdzys);
sjjson.s2011.bsj=parseFloat(sjjson.s2011.zys)+parseFloat(sjjson.s2011.tdsys)+parseFloat(sjjson.s2011.cjs)+
  ...
  parseFloat(sjjson.s2011.gdzctjs)+parseFloat(sjjson.s2011.qt)+parseFloat(sjjson.s2011.gdzys);
sjjson.s2012.bsj=parseFloat(sjjson.s2012.zys)+parseFloat(sjjson.s2012.tdsys)+parseFloat(sjjson.s2012.cjs)+
  ...
  parseFloat(sjjson.s2012.gdzctjs)+parseFloat(sjjson.s2012.qt)+parseFloat(sjjson.s2012.gdzys);
sjjson.s2013.bsj=parseFloat(sjjson.s2013.zys)+parseFloat(sjjson.s2013.tdsys)+parseFloat(sjjson.s2013.cjs)+
  ...
  parseFloat(sjjson.s2013.gdzctjs)+parseFloat(sjjson.s2013.qt)+parseFloat(sjjson.s2013.gdzys);
sjjson.s2014.bsj=parseFloat(sjjson.s2014.zys)+parseFloat(sjjson.s2014.tdsys)+parseFloat(sjjson.s2014.cjs)+
  ...
  parseFloat(sjjson.s2014.gdzctjs)+parseFloat(sjjson.s2014.qt)+parseFloat(sjjson.s2014.gdzys);
sjjson.s2015.bsj=parseFloat(sjjson.s2015.zys)+parseFloat(sjjson.s2015.tdsys)+parseFloat(sjjson.s2015.cjs)+
  ...
  parseFloat(sjjson.s2015.gdzctjs)+parseFloat(sjjson.s2015.qt)+parseFloat(sjjson.s2015.gdzys);
s2009.push({value:parseFloat(sjjson.s2009.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2009.qysds,2),name:'企业所得税'},
  {value:parseFloat(sjjson.s2009.qs,2),name:'契税'},{value:parseFloat(sjjson.s2009.yys,2),name:'营业税'},{value:parseFloat(sjjson.s2009.zys,2),name:'资源税'},
  {value:parseFloat(sjjson.s2009.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2009.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2009.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2009.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2009.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2009.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2009.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2009.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2009.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2009.qt,2),name:'其他'});
s2010.push({value:parseFloat(sjjson.s2010.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2010.qysds,2),name:'企业所得税'},
  {value:parseFloat(sjjson.s2010.qs,2),name:'契税'},{value:parseFloat(sjjson.s2010.yys,2),name:'营业税'}
    ,{value:parseFloat(sjjson.s2010.zys,2),name:'资源税'},
    {value:parseFloat(sjjson.s2010.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2010.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2010.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2010.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2010.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2010.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2010.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2010.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2010.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2010.qt,2),name:'其他'});
s2011.push({value:parseFloat(sjjson.s2011.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2011.qysds,2),name:'企业所得税'},
  {value:parseFloat(sjjson.s2011.qs,2),name:'契税'},{value:parseFloat(sjjson.s2011.yys,2),name:'营业税'}
    ,{value:parseFloat(sjjson.s2011.zys,2),name:'资源税'},
    {value:parseFloat(sjjson.s2011.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2011.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2011.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2011.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2011.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2011.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2011.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2011.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2011.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2011.qt,2),name:'其他'})
s2012.push({value:parseFloat(sjjson.s2012.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2012.qysds,2),name:'企业所得税'},
  {value:parseFloat(sjjson.s2012.qs,2),name:'契税'},{value:parseFloat(sjjson.s2012.yys,2),name:'营业税'}
    ,{value:parseFloat(sjjson.s2012.zys,2),name:'资源税'},
    {value:parseFloat(sjjson.s2012.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2012.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2012.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2012.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2012.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2012.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2012.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2012.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2012.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2012.qt,2),name:'其他'})
...
{value:parseFloat(sjjson.s2013.qs,2),name:'契税'},{value:parseFloat(sjjson.s2013.yys,2),name:'营业税'}
    ,{value:parseFloat(sjjson.s2013.zys,2),name:'资源税'},
    {value:parseFloat(sjjson.s2013.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2011.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2013.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2013.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2013.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2013.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2013.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2013.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2013.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2013.qt,2),name:'其他'})
s2014.push({value:parseFloat(sjjson.s2014.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2014.qysds,2),name:'企业所得税'},
    ...
    ,{value:parseFloat(sjjson.s2014.zys,2),name:'资源税'},
    {value:parseFloat(sjjson.s2014.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2014.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2014.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2014.tdzzs,2),name:'土地增值税'},
    {value:parseFloat(sjjson.s2014.fcs,2),name:'房产税'},{value:parseFloat(sjjson.s2014.ccs,2),name:'车船税'},
    {value:parseFloat(sjjson.s2014.yys1,2),name:'烟叶税'},{value:parseFloat(sjjson.s2014.gdzys,2),name:'耕地占用税'},
    {value:parseFloat(sjjson.s2014.gdzctjs,2),name:'固定资产投资方向调节税'},{value:parseFloat(sjjson.s2014.qt,2),name:'其他'})
...
hh2015.push({value:parseFloat(sjjson.s2015.gesds,2),name:'个人所得税'},{value:parseFloat(sjjson.s2015.qysds,2),name:'企业所得税'},
    ...
    {value:parseFloat(sjjson.s2015.tdsys,2),name:'土地使用税'},{value:parseFloat(sjjson.s2015.cjs,2),name:'城建税'},
    {value:parseFloat(sjjson.s2015.yhs,2),name:'印花税'},{value:parseFloat(sjjson.s2015.tdzzs,2),name:'土地增值税'},
