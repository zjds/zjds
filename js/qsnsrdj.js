 ...
 */
var citydata=[
  {name : '杭州市', value : 714945},
  {name : '绍兴市', value : 445063},
  {name : '湖州市', value : 192288},
  {name : '嘉兴市', value : 393655},
  {name : '温州市', value : 548513},
  {name : '宁波市', value : 819708},
  {name : '丽水市', value : 187285},
  {name : '舟山市', value : 88699},
  {name : '省局直属局', value : 3707},
  {name : '台州市', value : 346443},
  {name : '金华市', value : 560926},
  {name : '衢州市', value : 144293},
...
app.controller('ListCtrl',function($scope){
  ...
  for(i=0;i<citydata.length;i++){
   // k+=citydata[i].value;
    citydata[i].bfb=(citydata[i].value/k*100).toFixed(2);
  }
  $scope.renshu=k;

  $scope.citydata=  citydata.sort(by("value"));
})
require.config({
  paths: {
    echarts: '.././js/src',
